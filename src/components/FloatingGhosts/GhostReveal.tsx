...
export default function GhostReveal({
    ...
    return (
        <div
            className={`${styles.overlay} ${phase === "fadeout" ? styles.overlayFadeout : ""}`}
        >
            {/* Flash on explosion */}
            ...
            {(phase === "ghost-reveal" || phase === "fadeout") && (
                <div className={styles.revealContent}>
                    ...
                    <pre
                        ...
                        style={{
                            color: `${ghostColor}dd`,
                            textShadow: `0 0 20px ${ghostColor}, 0 0 50px ${ghostColor}88`,
                        }}
                    >
                        {GHOST_ART_STYLES[artStyle]}
                    </pre>
                    <div
                        className={styles.ghostName}
                        style={{
                            color: ghostColor,
                            textShadow: `0 0 18px ${ghostColor}, 0 0 36px ${ghostColor}66`,
                        }}
                    >
                        {ghostName}
                    </div>
